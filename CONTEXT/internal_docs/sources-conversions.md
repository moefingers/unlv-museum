...
| --- | ---------------------------- | ------------------------------------------------------------ | ---------------------------- | :--: | :-: | :-: | :----: | :-: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | js-exercises/js-dom-events   | moefingers/JS-Events-Demonstration                           | A (static)                   |  🟢  | 🟢  | ➖  |   ✅   | 🟡  | Five-page tour (target, bubbling, capturing, preventDefault, stopPropagation) — `pages` array declared. Smoke-tested 2026-05-20 at the OLD flat URL; reset ✓ → 🟡 pending re-verification at the new container path.                                                                                                                        |
| 2   | js-exercises/admin-portal    | moefingers/JS-Building-an-Admin-Portal                       | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Three-page (Admin, Books, API Docs); paired with `admin-portal-api` via `siblingApiClient`. Hosting fixes: db.json cleanup + localhost:3001→/api/admin-portal URL rewrites.                                                                                                                                                                 |
| 3   | js-exercises/shared-counter  | moefingers/JS-Building-a-Shared-Counter-Part-1               | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                             |
| 4   | js-exercises/interactive-map | moefingers/JS-Making-an-Interactive-Map                      | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Hosting fixes: 3s geolocation timeout + LV fallback, Foursquare key redacted (button no-ops gracefully).                                                                                                                                                                                                                                    |
| 5   | jaskis                       | moefingers/API-JASKIS                                        | E (backend-only)             |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Backend-only — surfaced via `/mongo-client`.                                                                                                                                                                                                                                                                                                |
...
| 7   | sql-injection-demo           | moefingers/iam-2-sql-injection-demo                          | A (static-copy w/ allowlist) |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Full UX port: `museum-ready/original` rewrites form action `/login` → `/api/sql-demo/login-html`. Static-copy with `include: ["index.html", "style.css"]` allowlist. Critical security lockdown: dedicated `sql_demo_runner` Postgres role + `SQL_DEMO_DATABASE_URL` env + `src/lib/db-sql-demo.ts` scoped client.                          |
| 8   | rest-rant                    | moefingers/rest-rant-monorepo                                | E (backend-only, temp)       |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Currently sync.config'd as `backend-only` (museum surfaces the API via `/api-client?api=rest-rant`). CRA frontend recipe deferred — see comment in `sync.config.ts`. Schema needs `pages`/`siblingApiClient` once frontend lands.                                                                                                           |
| 9   | rest-rant-ssr                | moefingers/UNLV-rest-rant                                    | (Next.js-native)             |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | SSR rewrite lives in `src/app/(ssr)/`; original branch retains the legacy Express+Mongo source as historical record.                                                                                                                                                                                                                        |
| 10  | admin-portal-api             | (paired with admin-portal)                                   | (api-client entry)           |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Backend half of admin-portal pair. Source-side metadata flows through admin-portal's row. `siblingFrontend` not surfaced today (api-client UI doesn't render the reverse cross-link yet — see architecture.md).                                                                                                                             |
...
| 13  | js-exercises/web-game        | moefingers/js-2-web-game-part-1and2and3 (+ part-4, part-7)   | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | 3 source repos correspond to one museum entry — pick latest (part 7).                                                                                                                                                                                                                                                                       |
...
| 22  | js-exercises/jacks-paint     | moefingers/UNLV-JS-Jacks-Paint                               | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Vanilla JS + canvas.                                                                                                                                                                                                                                                                                                                        |
...
| 28  | music-search                 | moefingers/RR-Music-Search                                   | B (cra)                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`. iTunes search SPA. Needs `allow-forms` iframe sandbox (already on `OriginalFrame`).                                                                                                                                                                                                                 |
| 29  | montys-mineral-spa           | moefingers/RR-React-Router-Montys-Mineral-Spa                | B (cra)                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                     |
| 30  | bootstrap                    | moefingers/RR-Getting-Started-With-Bootstrap                 | B (cra)                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                     |
| 31  | stylesheets                  | moefingers/RR-Stylesheets-React                              | B (cra)                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                     |
| 32  | rainbow                      | moefingers/rr-react-rainbow                                  | B (cra)                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                     |
| 33  | sql-injection-demo-api       | (paired with sql-injection-demo)                             | (api-client entry)           |  ➖  | ➖  | ➖  |   🔴   | 🔴  | Backend half of sql-injection-demo pair (same vulnerability surface, JSON-shaped for inspection in `/api-client`). Source-side metadata flows through #7's row.                                                                                                                                                                             |
| 34  | css-responsive-nav           | moefingers/css-responsive-nav                                | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                             |
| 35  | restaurant-menu              | moefingers/html-1-restaurant-menu-activity                   | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                             |
