...
| 2   | admin-portal           | moefingers/JS-Building-an-Admin-Portal                       | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Three-page (Admin, Books, API Docs); paired with `admin-portal-api` via `siblingApiClient`. Hosting fixes: db.json cleanup + localhost:3001→/api/admin-portal URL rewrites.                                                                                                                                                                 |
| 3   | shared-counter         | moefingers/JS-Building-a-Shared-Counter-Part-1               | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                             |
| 4   | interactive-map        | moefingers/JS-Making-an-Interactive-Map                      | A (static)                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Hosting fixes: 3s geolocation timeout + LV fallback, Foursquare key redacted (button no-ops gracefully).                                                                                                                                                                                                                                    |
