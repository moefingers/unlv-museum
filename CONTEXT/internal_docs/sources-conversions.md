...
| --------------------- | --------------------------------------------------------------------------------- | ------------------------ | :----: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| milestown             | moefingers/UNLV-MilestO-W-N                                                       | A (static)               |   🔴   | progression chain: original = milestown (UNLV-MilestO-W-N), enhanced external = `moefingers.github.io/milestown2/` (multiplayer remake — source repo `moefingers/milestown2`), reimagined external = `own3.vercel.app` |
