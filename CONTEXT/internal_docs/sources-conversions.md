...
| #   | Slug                                | Source repo                                                  | Type                         | Routes                                                                                                    | Conv | GH  | Fix | Schema |  ✓  | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- | ----------------------------------- | ------------------------------------------------------------ | ---------------------------- | --------------------------------------------------------------------------------------------------------- | :--: | :-: | :-: | :----: | :-: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1   | js-exercises/js-dom-events          | moefingers/JS-Events-Demonstration                           | A (static)                   | · `/js-exercises/js-dom-events?page=the-target-element` 🟡<br>· `/js-exercises/js-dom-events/enhanced` 🟡 |  🟢  | 🟢  | ➖  |   ✅   | 🟡  | Five-page tour (target, bubbling, capturing, preventDefault, stopPropagation) — `pages` array declared. Smoke-tested 2026-05-20 at the OLD flat URL; reset ✓ → 🟡 pending re-verification at the new container path. Enhanced is the 3-ring wavefront playground.                                                                                                                                                                                                                                |
| 2   | js-exercises/admin-portal           | moefingers/JS-Building-an-Admin-Portal                       | A (static)                   | · `/js-exercises/admin-portal?page=admin` 🔴<br>· `/api-client?api=admin-portal` 🔴                       |  🟢  | 🟢  | ✅  |   ✅   | 🔴  | Three-page (Admin, Books, API Docs); paired with `admin-portal-api` (row 10) via `siblingApiClient`. Hosting fixes: db.json cleanup + localhost:3001→/api/admin-portal URL rewrites — landed on museum-ready/original (4 non-README files differ from original). Routes column mirrors the pair.                                                                                                                                                                                                 |
| 3   | js-exercises/shared-counter         | moefingers/JS-Building-a-Shared-Counter-Part-1               | A (static)                   | · `/js-exercises/shared-counter` 🔴                                                                       |  🟢  | 🟢  | ➖  |   ✅   | 🔴  | Vanilla counter; no hosting fixes needed (museum-ready/original matches original byte-for-byte aside from the banner README).                                                                                                                                                                                                                                                                                                                                                                    |
| 4   | js-exercises/interactive-map        | moefingers/JS-Making-an-Interactive-Map                      | A (static)                   | · `/js-exercises/interactive-map` 🔴                                                                      |  🟢  | 🟢  | ✅  |   ✅   | 🔴  | Hosting fixes: 3s geolocation timeout + LV fallback, Foursquare key redacted (button no-ops gracefully) — landed on museum-ready/original.                                                                                                                                                                                                                                                                                                                                                       |
| 5   | jaskis                              | moefingers/API-JASKIS                                        | E (backend-only)             | · `/api-client?api=jaskis` 🔴                                                                             |  🟢  | 🟢  | ➖  |   ✅   | 🔴  | Backend-only — no frontend half (no `siblingFrontend`). Lives under `/api-client` exclusively. No source-side fixes apply.                                                                                                                                                                                                                                                                                                                                                                       |
| 6   | music-tour-api                      | moefingers/SQL-Music-Tour-API                                | E (backend-only)             | · `/api-client?api=music-tour` 🟢                                                                         |  🟢  | 🟢  | ➖  |   ✅   | 🟢  | Source-faithful rewrite landed 2026-05-20: 6 tables (bands, events, stages, meet_greets, set_times, stage_events), 15 endpoints across `bands/`, `events/`, `stages/` resource routers — lookups by NAME, mutations by ID. Seed mirrors source seeders verbatim (2 bands, 6 events, 2 stages, junctions). Verified every endpoint via curl.                                                                                                                                                      |
| 7   | sql-injection-demo                  | moefingers/iam-2-sql-injection-demo                          | A (static-copy w/ allowlist) | · `/sql-injection-demo` 🔴<br>· `/api-client?api=sql-demo` 🔴                                             |  🟢  | 🟢  | ✅  |   ✅   | 🔴  | Full UX port: `museum-ready/original` rewrites form action `/login` → `/api/sql-demo/login-html`. Static-copy with `include: ["index.html", "style.css"]` allowlist. Critical security lockdown: dedicated `sql_demo_runner` Postgres role + `SQL_DEMO_DATABASE_URL` env + `src/lib/db-sql-demo.ts` scoped client. Paired with row 33.                                                                                                                                                           |
| 8   | rest-rant                           | moefingers/rest-rant-monorepo                                | E (backend-only, temp)       | · `/api-client?api=rest-rant` 🔴<br>· `/rest-rant` (planned)                                              |  🟢  | 🟢  | ➖  |   ✅   | 🔴  | Currently sync.config'd as `backend-only` (museum surfaces the API via `/api-client?api=rest-rant`). CRA frontend recipe deferred — see comment in `sync.config.ts`. Schema will need `pages`/`siblingApiClient` updates once frontend lands; second route will become live then.                                                                                                                                                                                                                |
| 9   | rest-rant-ssr                       | moefingers/UNLV-rest-rant                                    | (Next.js-native)             | · `/rest-rant-ssr` 🔴                                                                                     |  🟢  | 🟢  | ➖  |   ✅   | 🔴  | SSR rewrite lives in `src/app/(ssr)/`; original branch retains the legacy Express+Mongo source as historical record. Distinct museum entry from row 8 — same source backend, different museum surface.                                                                                                                                                                                                                                                                                           |
| 10  | admin-portal-api                    | (paired with admin-portal)                                   | (api-client entry)           | · `/js-exercises/admin-portal?page=admin` 🔴<br>· `/api-client?api=admin-portal` 🔴                       |  ➖  | ➖  | ➖  |   ✅   | 🔴  | Backend half of admin-portal pair. Source-side metadata flows through admin-portal's row (row 2). `siblingFrontend: "admin-portal"` set bidirectionally; api-client UI doesn't render the reverse cross-link yet, but the schema is honest.                                                                                                                                                                                                                                                      |
| 11  | milestown                           | moefingers/UNLV-MilestO-W-N                                  | A (static)                   | · `/milestown` 🔴                                                                                         |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Progression chain: original = milestown, enhanced external = `moefingers.github.io/milestown2/` (source `moefingers/milestown2`), reimagined external = `own3.vercel.app`.                                                                                                                                                                                                                                                                                                                       |
| 12  | gwhac-a-mole                        | moefingers/gwhac-a-mole                                      | B (cra)                      | · `/gwhac-a-mole` 🔴                                                                                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Strong tag → green (Guacamole) subtitle already applied.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 13  | js-exercises/web-game               | moefingers/js-2-web-game-part-1and2and3 (+ part-4, part-7)   | A (static)                   | · `/js-exercises/web-game` 🔴                                                                             |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | 3 source repos correspond to one museum entry — pick latest (part 7).                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 14  | commerce-array                      | moefingers/mp2-ecommerce                                     | C (vite) + D (postPatch)     | · `/commerce-array` 🔴                                                                                    |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Minified bundle has AWS API Gateway URLs that need rewriting to local JSON; existing `scripts/patch-commerce-array.mjs` would be the postPatch.                                                                                                                                                                                                                                                                                                                                                  |
| 15  | enterprize                          | moefingers/enterprize                                        | (Next.js-native or external) | · `/enterprize` 🔴                                                                                        |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Evolution of quirk-truck into a Next.js 15 + Prisma + NeonDB app; separate source repo. Reimagined external = `enterprize-pi.vercel.app`. **Bug to fix in `projects.tsx`**: currently iframes `quirk-truck/index.html` as its `original` while `techOriginal` lists the Next.js stack — needs the real enterprize bundle or a placeholder.                                                                                                                                                       |
| 16  | nextjs-dashboard                    | —                                                            | (none)                       | · `/nextjs-dashboard` 🔴                                                                                  |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Placeholder card explaining the deployment is gone; no source iframe.                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 17  | art-gallery                         | moefingers/UNLV-react-art-gallery                            | B (cra)                      | · `/art-gallery` 🔴                                                                                       |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 18  | quirk-truck                         | moefingers/quirkTruck                                        | B (cra)                      | · `/quirk-truck` 🔴                                                                                       |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 19  | timer-stopwatch                     | moefingers/react-timer-stopwatch-v2                          | C (vite)                     | · `/timer-stopwatch` 🔴                                                                                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 20  | food-truck                          | moefingers/foodTruckUNLV                                     | A (static)                   | · `/food-truck` 🔴                                                                                        |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Dead Google Drive URLs for 5 images (3 menu pics + Facebook/Instagram icons), already substituted with local SVGs at `public/originals/food-truck/images/` — these need to land on `museum-ready/original`.                                                                                                                                                                                                                                                                                      |
| 21  | stock-charts                        | moefingers/JS-Stock-Charts                                   | A (static)                   | · `/stock-charts` 🔴                                                                                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Verify static — has Chart.js client-side.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 22  | js-exercises/jacks-paint            | moefingers/UNLV-JS-Jacks-Paint                               | A (static)                   | · `/js-exercises/jacks-paint` 🔴                                                                          |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Vanilla JS + canvas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 23  | copycat                             | moefingers/copycatactivity                                   | A (static)                   | · `/copycat` 🔴                                                                                           |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | HTML/CSS only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 24  | my-values                           | moefingers/My-Values                                         | A (static)                   | · `/my-values` 🔴                                                                                         |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 25  | petfax                              | moefingers/PY-PetFax                                         | E (special)                  | · `/petfax` 🔴                                                                                            |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Flask app — was pre-built to static; decide approach: keep static snapshot or run Flask at edge.                                                                                                                                                                                                                                                                                                                                                                                                 |
| 26  | python-fundamentals                 | moefingers/python-day-3/4/5/9, python_functions_practice\_\* | E (special)                  | · `/python-fundamentals` 🔴                                                                               |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Pyodide loads .py files; multiple source repos for one museum entry.                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 27  | html-css-fundamentals               | moefingers/CSS-The-Hacker-Times-Part-1 (and siblings)        | A (static)                   | · `/html-fundamentals` 🔴<br>· `/css-fundamentals` 🔴                                                     |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | "Hacker Times" demo is the primary; siblings split into html-fundamentals (chapter 2.x) and css-fundamentals (chapter 3.x) containers.                                                                                                                                                                                                                                                                                                                                                           |
| 28  | music-search                        | moefingers/RR-Music-Search                                   | B (cra)                      | · `/react-exercises/music-search` 🔴                                                                      |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`. iTunes search SPA. Needs `allow-forms` iframe sandbox (already on `OriginalFrame`).                                                                                                                                                                                                                                                                                                                                                                      |
| 29  | montys-mineral-spa                  | moefingers/RR-React-Router-Montys-Mineral-Spa                | B (cra)                      | · `/react-exercises/montys-mineral-spa` 🔴                                                                |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 30  | bootstrap                           | moefingers/RR-Getting-Started-With-Bootstrap                 | B (cra)                      | · `/react-exercises/bootstrap` 🔴                                                                         |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 31  | stylesheets                         | moefingers/RR-Stylesheets-React                              | B (cra)                      | · `/react-exercises/stylesheets` 🔴                                                                       |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 32  | rainbow                             | moefingers/rr-react-rainbow                                  | B (cra)                      | · `/react-exercises/rainbow` 🔴                                                                           |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  | Container leaf under `react-exercises`.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 33  | sql-injection-demo-api              | (paired with sql-injection-demo)                             | (api-client entry)           | · `/sql-injection-demo` 🔴<br>· `/api-client?api=sql-demo` 🔴                                             |  ➖  | ➖  | ➖  |   ✅   | 🔴  | Backend half of sql-injection-demo pair. Source-side metadata flows through #7's row. `siblingFrontend: "sql-injection-demo"` set; the partner's `siblingApiClient: "sql-demo"` matches api-data.ts's id (NOT the partner's slug — see asymmetry note in resolveSiblingLink's docstring).                                                                                                                                                                                                        |
| 34  | css-responsive-nav                  | moefingers/css-responsive-nav                                | A (static)                   | · `/css-responsive-nav` 🔴                                                                                |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 35  | restaurant-menu                     | moefingers/html-1-restaurant-menu-activity                   | A (static)                   | · `/restaurant-menu` 🔴                                                                                   |  🔴  | 🔴  | 🔴  |   🔴   | 🔴  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| 36  | react-exercises/declarative-counter | moefingers/rr-1-react-and-front-end-libraries                | B (cra)                      | · `/react-exercises/declarative-counter` 🔴                                                               |  🔴  | 🔴  | 🔴  |   ✅   | 🔴  | Chapter 7.1.3 of the React Router series — counter UI rewritten in React. Pedagogically deliberate counterpart to row 3 (`js-exercises/shared-counter`) — same exercise, vanilla JS vs React. Cross-linked bidirectionally via `relatedEntries`. Source repo's actual exercise lives in subdir `7.1.3-declarative-counter/`; recipe will need `cwd` set to that path. Original branch is `shepherd` today; conversion will rename to `original` + create `museum-ready/original` per sources.md. |
