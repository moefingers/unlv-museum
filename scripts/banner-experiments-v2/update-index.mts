/**
 * Scans public/banner-experiments-v2/ for *.svg and rewrites the `files` array
 * in its index.html. Mirror of scripts/banner-experiments/update-index.mts but
 * targeting the v2 gallery.
 *
 * Usage:
 *   pnpm tsx scripts/banner-experiments-v2/update-index.mts
 */
...
const dir = resolve(here, "..", "..", "public", "banner-experiments-v2");
