/**
 * Scans public/banner-experiments-v3/ for *.svg and rewrites the `files` array
 * in its index.html.
 *
 * Usage:
 *   pnpm tsx scripts/banner-experiments-v3/update-index.mts
 */
...
const dir = resolve(here, "..", "..", "public", "banner-experiments-v3");
